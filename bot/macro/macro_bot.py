...
class MacroBotMixin(BotAI):
    ...
    # async def _build_add_ons(self, obs):
    ...
    # async def _build_depots(self, obs):
    ...
    #             )
    #         else:
    #             await self._build_structure(UnitTypeId.SUPPLYDEPOT)

    #     await self._handle_depot_height(obs)

    # async def _build_production(self, obs):
    #     # 1-1-1
    #     # 3-1-1
    #     # 5-1-1
    #     # 5-2-1
    ...
    #                 UnitTypeId.FACTORY
    #             ):
    #                 await self._build_structure(UnitTypeId.FACTORY)
    #             elif len(production_buildings) == 2 and not self.already_pending(
    #                 UnitTypeId.STARPORT
    #             ):
    #                 await self._build_structure(UnitTypeId.STARPORT)

    #     elif self.build_type == "MECH":
    #         pass

    # async def _build_refineries(self, obs):
    ...
    # async def _build_units(self, obs):
    ...
    # async def _build_workers(self, obs):
    ...
    # async def _distribute_workers(self, obs):
    #     await self.distribute_workers()

    # async def _expand(self, obs):
    ...
    # async def _finish_buildings_under_construction(self, obs):
    #     structures_to_finish = self.structures_without_construction_SCVs()
    #     for structure in structures_to_finish:
    #         await self._build_structure(structure.type_id, structure.position)

    # async def _handle_depot_height(self, obs):
    ...
    #     await self._build_depots()
    #     await self._build_refineries()
    #     await self._expand()
    #     await self._build_production()
    #     await self._finish_buildings_under_construction()
    #     await self._build_add_ons()
    #     await self._build_units()

    # async def _build_structure(
    #     self, structure_id, position=None, can_afford_check=True
    # ):
    ...
    #             structure_id,
    #             self.townhalls.random.position.towards(self.game_info.map_center, 5),
